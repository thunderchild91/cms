...
(function() {
  var ClientRequest, EMPTY_IMAGE, IMAGE_FILE, LARGE_RAW_FILE, LARGE_VIDEO, Q, RAW_FILE, TEST_TAG, _, cloudinary, expect, fs, helper, http, https, sinon;
  ...
  describe("uploader", function() {
    ...
    describe("upload_chunked", function() {
      ...
      it("should support uploading a small raw file", function(done) {
        return fs.stat(RAW_FILE, function(err, stat) {
          return cloudinary.v2.uploader.upload_large(RAW_FILE, {
            tags: TEST_TAG
          }, function(error, result) {
            if (error != null) {
              return done(new Error(error.message));
      ...
      return it("should support uploading large video files", function(done) {
        ...
        return fs.stat(LARGE_VIDEO, function(err, stat) {
          ...
          return cloudinary.v2.uploader.upload_chunked(LARGE_VIDEO, {
            ...
            return cloudinary.v2.uploader.destroy(result.public_id, function() {
              return done();
            });
          });
        });
    ...
    context(":responsive_breakpoints", function() {
      return context(":create_derived", function() {
    ...
    return describe("explicit", function() {
      var spy, xhr;
      spy = void 0;
      xhr = void 0;
      before(function() {
      ...
      return describe(":invalidate", function() {
        return it("should should pass the invalidate value to the server", function(done) {
...
//# sourceMappingURL=uploader_spec.js.map
