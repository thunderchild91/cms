...
(function() {
  var Q, TEST_TAG, _, api, cloud_name, cloudinary, expect, fs, helper, http, itBehavesLike, os, root_path, sharedExamples, test_cloudinary_url, utils,
    slice = [].slice;
  ...
  describe("utils", function() {
    ...
    describe("overlay and underlay", function() {
      ...
      it("should support " + param, function() {
        ...
        for (i = 0, len = layers_options.length; i < len; i++) {
          ...
          name = layer[0], options = layer[1], result = layer[2];
          opt = {};
          opt[param] = options;
    ...
    sharedExamples("a signed url", function(specific_options, specific_transformation) {
      ...
      if (specific_transformation == null) {
