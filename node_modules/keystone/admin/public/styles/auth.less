...
// ------------------------------
.auth-box {
	box-shadow: 0 2px 1px rgba(94,61,160,0.75);
    background:rgba(118,83,189,0.75);
	border-radius: @border-radius-base;
	border: 2px rgba(94,61,160,0.75);
...
.auth-box__brand {
	...
	@media (min-width: @screen-sm) {
		...
		border-right: 2px solid rgba(94,61,160,0.75);
		min-height: 185px;
		line-height: 185px;
		padding-right: @gutter-width;
	}
	@media (max-width: @screen-xs-max) {
		border-bottom: 2px solid rgba(94,61,160,0.75);
