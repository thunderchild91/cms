...
.removeNavbarPadding {
	...
	background:   linear-gradient(to right,rgba(118,83,189,0.8), rgba(118,83,189,1));
	border: 2px solid rgba(255,255,255,0.5) !important;
	border-radius: 4px !important;
}
// .navbar-default .navbar-nav>li>a {
// 	color: rgba(255,255,255,.75) !important;
// font-family: square_kidsregular;
// font-size:18px;
// margin: 5px;

// }
.navbar-default .app-nav>li>a {
	color: rgba(255,255,255,.75) !important;
font-family: square_kidsregular;
font-size:18px;
margin: 5px;
...
.navbar-default .app-nav>li>a:hover, .navbar-default .app-nav>li>a:focus {
 color: white !important;
 background:   linear-gradient(to right,rgba(118,83,189,0.5), rgba(118,83,189,0.9));
 border: 2px solid rgba(255,255,255,0.5); 
}
.navbar-default .app-nav > .active > a, .navbar-default .app-nav > .active > a:hover, .navbar-default .app-nav > .active > a:focus{
background:   linear-gradient(to right,rgba(118,83,189,0.5), rgba(118,83,189,0.9));
border: 2px solid rgba(255,255,255,0.5);
