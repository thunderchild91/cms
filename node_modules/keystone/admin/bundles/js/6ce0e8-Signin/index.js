		...
		value: function renderDialog() {
			...
			return _react2.default.createElement(
				'div',
				{
					...
					style: { overflow: 'scroll', display: '-webkit-box' }
				},
				_react2.default.createElement(
					'div',
...
// import PrimaryNavigation from '../App/components/Navigation/Primary/index';
/**
...
},{"./components/Alert":66,"./components/Brand":67,"./components/LoginForm":68,"./components/NavBar":69,"./components/UserInfo":70,"classnames":undefined,"object-assign":76,"react":undefined,"xhr":undefined}],66:[function(require,module,exports){
'use strict';
...
var AlertView = function AlertView(props) {
	if (props.isInvalid) {
		return _react2.default.createElement(
			_elemental.Alert,
			{ key: 'error', color: 'danger', style: { textAlign: 'center', borderColor: '#f5c6cb', backgroundColor: '#f8d7da', color: '#721c24' } },
			props.invalidMessage
		);
	} else if (props.signedOut) {
		return _react2.default.createElement(
			_elemental.Alert,
			{ key: 'signed-out', color: 'danger', style: { textAlign: 'center', borderColor: '#f5c6cb', backgroundColor: '#f8d7da', color: '#721c24' } },
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				{ label: 'Email', htmlFor: 'email', style: { color: '#ffffff !important' } },
			...
			_react2.default.createElement(
				_elemental.FormField,
				{ label: 'Password', htmlFor: 'password', style: { color: '#ffffff !important' } },
				_react2.default.createElement(_elemental.FormInput, {
					type: 'password',
					name: 'password',
					onChange: handleInputChange,
			...
			_react2.default.createElement(
				'button',
				{ className: 'btn btn-cms', type: 'submit' },
				' Sign In '
			)
		)
	);
...
var NavBar = function NavBar(_ref) {
	...
	return _react2.default.createElement(
		'div',
		{ className: 'removeHeaderStyle' },
		_react2.default.createElement(
			'div',
			{ className: 'container-fluid nopadding' },
			_react2.default.createElement(
				'nav',
				{ className: 'navbar removeNavbarPadding navbar-default navbar-static-top' },
				_react2.default.createElement(
					'container',
					{ className: 'container-fluid' },
					_react2.default.createElement(
						'ul',
						{ className: 'nav app-nav app-nav--primary app-nav--left' },
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement(
					...
					_react2.default.createElement(
						'ul',
						{ className: 'nav app-nav app-nav--primary app-nav--right' },
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement(
...
},{"../../App/elemental":64,"react":undefined}],71:[function(require,module,exports){
'use strict';
...
_reactDom2.default.render(_react2.default.createElement(
	...
	_react2.default.createElement(
		...
		_react2.default.createElement(
			'div',
			{ className: 'section section-background-image' },
			_react2.default.createElement('img', { src: '/keystone/images/banner-incont.jpg', alt: 'CMS' })
		)
	),
...
},{"./Signin":65,"./components/NavBar":69,"qs":undefined,"react":undefined,"react-dom":undefined}],72:[function(require,module,exports){
'use strict';
