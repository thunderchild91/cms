				...
				<div className="dashboard-groups">
					...
					{Keystone.nav.flat ? (
						...
						<div>
							...
							{/* <div className="dashboard-group" data-section-label="Other">
								<div className="dashboard-group__heading">
									<span className="dashboard-group__heading-icon octicon-database">
									</span>
								</div>
								<div className="dashboard-group__lists">
									<div className="dashboard-group__list">
										<span className="dashboard-group__list-inner">
											<a className="dashboard-group__list-tile" href="/keystone/file-uploads">
												<div className="dashboard-group__list-label">
													Create New Page
												</div>
											</a>
											<a class="dashboard-group__list-create octicon octicon-plus" title="Create" tabindex="-1" href="/keystone/file-uploads?create"></a>
										</span>
									</div>
								</div>
							</div> */}
